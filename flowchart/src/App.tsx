...
const allSteps: { id: string; label: string; description: string; phase: Phase }[] = [
  ...
  { id: '3', label: 'Run ralphex', description: 'Starts the Codex loop', phase: 'setup' },
  // Loop phase
  { id: '4', label: 'Codex picks a story', description: 'Finds next passes: false', phase: 'loop' },
  ...
  return (
    <div className="app-container">
      <div className="header">
        <h1>How Ralphex Works with GPT Codex</h1>
        <p>Autonomous GPT Codex loop for completing PRDs</p>
      </div>
